              ...
              <li>
               <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url();?>application/assets/diagnostic_theme/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url();?>application/assets/diagnostic_theme/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
         ...
         <div class="modal-dialog" style="width:25%;">
           <div class="modal-content">
             ...
             <div class="modal-footer">
			    <a href="<?php echo base_url();?>administratordashboard" class="btn bg-olive btn-flat margin pull-left">Dashboard</a>
...
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/area.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/facility.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/district.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/pincode.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/pathologycenter.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/department.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/subdepartment.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/investigation.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/discount.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/hub.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/collector.js"></script>
<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/enquiry.js"></script>
