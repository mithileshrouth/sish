                  ...
                  <div class="form-group">
                    ...
                    <select id="block" name="block" class="form-control selectpicker" data-show-subtext="true" data-live-search="true" >
                      ...
                      if($bodycontent['blockList'])
                      {
                        ...
                        { ?>
                            <option value="<?php echo $blocklist->id; ?>" <?php if(($bodycontent['mode']=="EDIT") && $bodycontent['TuEditdata']->district_id==$districtlist->id){echo "selected";}else{echo "";} ?> ><?php echo $blocklist->name; ?></option>
                <?php   }
                      }
                      ?>
