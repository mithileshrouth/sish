...
text-align:center;padding:10px;padding: 10px;margin-bottom: 50px;display:none;
        ...
        <div class="box-body" id="PatientList">
          <?php
          $attr = array("id"=>"PaymentGenUpdt","name"=>"PaymentGenUpdt");
              echo form_open('',$attr); ?>
 ...
 <div class="container" style="margin-top:50px; ">
  <div class="form-group row">
    ...
    <div class="form-group row" style="margin-top:20px;" id="paygenretedUpdate">
      <div class="btnDiv">
              <button type="submit" class="btn btn-primary formBtn" id="generatedUpdate" style="display: inline-block;width:200px;">Update</button>
            </div>
    </div>
