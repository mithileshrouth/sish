  <script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/eye_record.js"></script>
...
tr.group:hover {
  ...
  <section class="content-header">
      ...
      <div class="col-md-12">
        <div class="box box-primary formBlock">
              <div class="box-header with-border">
                <h3 class="box-title">Eye Record</h3>
   ...
   <?php /*Payment list*/
              $attr = array("id"=>"EyeRecordForm","name"=>"EyeRecordForm");
              echo form_open('',$attr); ?>
                <div class="box-body">
    ...
    <section id="loadEyeRecordList" style="padding: 15px;">
