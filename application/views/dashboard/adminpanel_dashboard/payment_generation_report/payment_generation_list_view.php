  <script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/payment_generation_report.js"></script>
...
tr.group:hover {
  ...
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Payment Generation Report(s)</li>
      </ol>
    </section>
      ...
      <div class="col-md-12">
        <div class="box box-primary formBlock">
              <div class="box-header with-border">
                <h3 class="box-title">Payment Generation Report(s)</h3>
   ...
   <?php /*Payment list*/
              $attr = array("id"=>"PaymentGenReportForm","name"=>"PaymentGenReportForm");
              echo form_open('',$attr); ?>
                <div class="box-body">
