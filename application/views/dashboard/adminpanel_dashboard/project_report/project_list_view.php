  <script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/projetstatus_report.js"></script>
...
tr.group:hover {
  ...
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Project Status Report</li>
      </ol>
    </section>
   ...
   <?php /*Payment list*/
              $attr = array("id"=>"ProjectStatusReportForm","name"=>"ProjectStatusReportForm");
              echo form_open('',$attr); ?>
                <div class="box-body">
                 ...
                 <div class="form-group">
                     <label for="projectList">Project</label> 
                      ...
                      if($bodycontent['projectList'])
                      {
                        ...
                        { ?>
                            <option value="<?php echo $value->id; ?>" <?php echo "selected";?>><?php echo $value->project; ?></option>
                <?php   }
                      }
                      ?>
                  ...
                  <div class="form-group">
                     <label for="distcoordinatorList">District Coordinator</label> 
                     <div id="distcoordinatorview">
                        <select id="distcoordinator" name="distcoordinator[]" class="form-control selectpicker" data-show-subtext="true" data-actions-box="true" data-live-search="true" multiple="multiple">
                   <?php 
                      if($bodycontent['distCoordinatorList'])
                      {
                        foreach($bodycontent['distCoordinatorList'] as $value)
                        { ?>
                            <option value="<?php echo $value->id; ?>"><?php echo $value->dist_coordinator."  [ ".$value->name." ]"; ?></option>
                <?php   }
                      }
                      ?>
                        </select>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <p id="project_manual_err_msg" class="form_error"></p>
